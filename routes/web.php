...
Route::resource('reporte/chartreserva', 'ChartReservaController');
Route::resource('operacion/reservasespeciales', 'ReservaEspecialController');
...
Route::get('carre/reserva/get/{idfacu}', 'ChartReservaController@getCarre');
