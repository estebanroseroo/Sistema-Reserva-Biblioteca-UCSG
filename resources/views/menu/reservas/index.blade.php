...
<h2><b>Mis reservas </b><a href="{{url('menu/reservas/create')}}"><button class="my-button"><i class="fa fa-plus"><b>Agregar</b></i></button></a></h2>
<br>
...
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
	...
	<div class="input-group">
		...
		<a href="{{url('menu/reservas/create')}}"><button class="my-button"><i class="fa fa-graduation-cap"><b>Nueva reserva</b></i></button></a>
		</span>
	</div>
	</div>
