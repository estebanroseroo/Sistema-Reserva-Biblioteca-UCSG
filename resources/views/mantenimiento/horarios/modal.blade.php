<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$h->idhora}}">
	{{Form::Open(array('action'=>array('HorarioController@destroy', $h->idhora), 'method'=>'delete'))}}
	<div class="modal-dialog">
		<div class="modal-content">
		<div class="my-modal-header">
			<h2 class="modal-title">Eliminar Horario</h2>
		</div>
