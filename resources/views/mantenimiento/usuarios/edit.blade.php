...
<div class="row">
	...
	<div class="form-group row">
        <label for="name" class="col-md-4 col-form-label text-md-right" style="color: #000;">{{ __('Nombre') }}</label>
         ...
         onkeyup="this.value = this.value.replace(/\b\w/g, l => l.toUpperCase());" class="form-control" name="name" oncopy="return false" onpaste="return false" onkeypress="return lettersOnly(event)" value="{{ $usunombre }}" style="color: #000;" maxlength="15">
        </div>
     </div>
     ...
     <div class="form-group row">
        ...
        onkeyup="this.value = this.value.replace(/\b\w/g, l => l.toUpperCase());" class="form-control" name="apellido" oncopy="return false" onpaste="return false" onkeypress="return lettersOnly(event)" value="{{ $usuapellido }}" style="color: #000;" maxlength="15">
        </div>
     </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
        <input id="telefono" type="text" placeholder="Teléfono" class="form-control" name="telefono" value="{{ $usuario->telefono }}" onkeypress="return isNumberKey(event)" maxlength="10" oncopy="return false" onpaste="return false" style="color: #000;">
        </div>
    </div>
