...
<div class="row">
    ...
    <div class="form-group">
        ...
        <input id="nombre" type="text" name="nombre" class="form-control" value="{{$tipousuario->nombre}}" placeholder="Nombre" onkeyup="this.value = this.value.replace(/\b\w/g, l => l.toUpperCase());" oncopy="return false" onpaste="return false" style="color: #000;" maxlength="15">
    </div>
    <div class="form-group">
