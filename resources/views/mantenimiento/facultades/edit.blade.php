...
<div class="row">
	...
	<div class="form-group">
		...
		<input id="nombre" type="text" name="nombre" class="form-control" value="{{$facultad->nombre}}" placeholder="Nombre" onkeyup="this.value = this.value.toUpperCase();" oncopy="return false" onpaste="return false" style="color: #000;" maxlength="50">
	</div>
	<div class="form-group">
